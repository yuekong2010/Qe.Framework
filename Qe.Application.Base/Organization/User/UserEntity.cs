...
namespace Qe.Application.Base.Organization.User
{
    public class UserEntity
    {
        ...
        /// 企业Id
        /// </summary>		
        [Column("F_EnterpriseId")]
        public string F_EnterpriseId { get; set; }
        /**********************APP******************************/
        /// <summary>
        /// 阀门技师工作年限
        /// </summary>		
        [Column("F_VALVETECHNICIANAGELIMIT")]
        public string F_ValveTechnicianAgeLimit { get; set; }
        /// <summary>
        /// 阀门技师性别
        /// </summary>		
        [Column("F_VALVETECHNICIANGENDER")]
        public string F_ValveTechnicianGender { get; set; }
        /// <summary>
        /// 阀门技师职称
        /// </summary>		
        [Column("F_VALVETECHNICIANTITLE")]
        public string F_ValveTechnicianTitle { get; set; }
        /// <summary>
        /// 阀门技师证书编号
        /// </summary>		
        [Column("F_VALVETECHNICIANNUM")]
        public string F_ValveTechnicianNum { get; set; }
        /// <summary>
        /// 阀门技师证书照片
        /// </summary>
        [Column("F_VALVETECHNICIANCERTIFICATE")]
        public string F_ValveTechnicianCertificate { get; set; }
        /// <summary>
        /// 阀门技师出生日期
        /// </summary>		
        [Column("F_VALVETECHNICIANDATEOFBIRTH")]
        public DateTime? F_ValveTechnicianDateOfBirth { get; set; }
        /// <summary>
        /// 账号标志位置
        /// </summary>		
        [Column("F_USERTYPE")]
        ...
        public void Create()
        {
            ...
            this.F_EnterpriseId = userInfo.isSystem ? Guid.NewGuid().ToString() : userInfo.enterpriseId;
        }
        /// <summary>
        /// 编辑调用
        /// </summary>
