...
namespace Qe.Database.SqlServer
{
    public class DatabaseContext: DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("Qe.DataBase.SqlServer.DLL", "Qe.Application.Mapping.DLL").Replace("file:///", "");
